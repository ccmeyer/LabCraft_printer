...
//== CAMERA PINS ===========================================
const int cameraPin = PB6;  //BL_TOUCH - J43 middle pin of 5
const int flashPin = PB0;   //RGB_LED - J37 middle pin of 3
...
// --DRIVER 1--
// Standard control modality
const bool Y_INV_DIR = true; // Invert direction for Motor1_1
