...
const int X_EN_PIN = PF14;      // Enable - EN pin top left
const int X_DIR_PIN = PF12;     // Direction - DIR pin bottom left
const int X_STEP_PIN = PF13;    // Step - STP pin second from bottom left

// UART communication - Requires jumper in JXC between pins 1 and 2 (second from left column, X is for driver number)
const int X_SW_TX = PC4;        // UART-SoftwareSerial receive pin - Attached to the DRIVERX_CS pins of the motor
...
// Standard control modality
const int Z_EN_PIN = PG5;      // Enable - EN pin top left
const int Z_DIR_PIN = PG3;     // Direction - DIR pin bottom left
const int Z_STEP_PIN = PF11;    // Step - STP pin second from bottom left

// UART communication - Requires jumper in JXC between pins 1 and 2 (second from left column, X is for driver number)
const int Z_SW_TX = PC6;        // UART-SoftwareSerial receive pin - Attached to the DRIVERX_CS pins of the motor
