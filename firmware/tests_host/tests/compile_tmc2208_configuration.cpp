...
static_assert(TMC2208Configuration::preservesMres2PhysicalRate(40000u),
              "40 kHz logical rate must preserve the MRES2 physical rate");
static_assert(
    TMC2208Configuration::preservesMres2PhysicalAcceleration(140000u),
    "140k logical units/s2 must preserve the MRES2 physical acceleration");
