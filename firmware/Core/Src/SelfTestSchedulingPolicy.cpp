                                  ...
                                  size_t metricsLen)
{
  ...
  if (metrics != nullptr && metricsLen > 0u) {
    std::snprintf(metrics,
                  metricsLen,
                  "sm=%u;rf=%lu;yc=%lu;txm=%lu;txt=%lu;pg=%lu;pa=%lu;ph=%u;pha=%lu;la=%lu;se=%lu;re=%lu;bc=%lu;h=%u;r=%lu;x=%lu;hw=%lu;sf=%u",
                                              ...
                                              size_t metricsLen)
{
  ...
  if (metrics != nullptr && metricsLen > 0u) {
    std::snprintf(metrics,
                  metricsLen,
                  "v=%u;ex=%u;pa=%lu;ph=%u;pha=%lu;la=%lu;pg=%lu;se=%lu;re=%lu;bc=%lu;lp=%lu;h=%u;r=%lu;x=%lu;hw=%lu;tk=%lu;sf=%u",
                  contextValid ? 1u : 0u,
