...
| `0x65` | `CMD_REFUEL_VACUUM_ENTER` | host->MCU | `p1=targetRaw`, `p2=prepPositionSteps`, `p3=moveHz` | `executeCommand` (`regR().enterVacuumMode`) | dual-port only |
