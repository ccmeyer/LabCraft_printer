...
- `tools/run_selftest.py`
  ...
  - Coordinated XY has three supported focused selectors. `--coordinated-xy-production-mres3-suite` maps to `2097` and emits `[2087,2088,2089,2090]` under active manifest `coordinated_xy_production_mres3_v2`. It strictly gates the fixed MRES3/two-edge/conditional-rearm implementation, exact 53,416/90,000/110,000 native totals, 220,000 callbacks, complete IRQ/entry/deadline coverage, bounded timing, status/watchdog evidence, homes, and driver configuration.
