...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        super().__init__()
        self.shortcuts = [
            Shortcut("Move Forward",QtCore.Qt.Key_Up, "Up", lambda: self.machine.set_relative_coordinates(self.step_size,0,0,manual=True)),
            Shortcut("Move Back",QtCore.Qt.Key_Down,"Down", lambda: self.machine.set_relative_coordinates(-self.step_size,0,0,manual=True)),
            Shortcut("Move Left", QtCore.Qt.Key_Left,"Left", lambda: self.machine.set_relative_coordinates(0,-self.step_size,0,manual=True)),
            Shortcut("Move Right",QtCore.Qt.Key_Right, "Right", lambda: self.machine.set_relative_coordinates(0,self.step_size,0,manual=True)),
            Shortcut("Move Up", "k", "k", lambda: self.machine.set_relative_coordinates(0,0,self.step_size,manual=True)),
            Shortcut("Move Down", "m","m", lambda: self.machine.set_relative_coordinates(0,0,-self.step_size,manual=True)),
            Shortcut("Set pressure to 2 psi", "0","0", lambda: self.machine.set_absolute_pressure(2,manual=True)),
            Shortcut("Set pressure to 0 psi", "5","5", lambda: self.machine.set_absolute_pressure(0,manual=True)),
            Shortcut("Large Increase Pressure", "9","9", lambda: self.machine.set_relative_pressure(0.5,manual=True)),
            ...
            Shortcut("Print 5", "c","c", lambda: self.print_droplets(5,manual=True)),
            Shortcut("Print 20", "v","v", lambda: self.print_droplets(20,manual=True)),
            Shortcut("Print 100", "b","b", lambda: self.print_droplets(100,manual=True)),
