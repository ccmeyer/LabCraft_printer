...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.shortcuts = [
            ...
            Shortcut("Set pressure to 2 psi", "0","0", lambda: self.machine.set_absolute_pressure(0.5)),
            Shortcut("Set pressure to 0 psi", "5","5", lambda: self.machine.set_absolute_pressure(0)),
            Shortcut("Large Increase Pressure", "9","9", lambda: self.machine.set_relative_pressure(0.1)),
            Shortcut("Small Increase Pressure", "8","8", lambda: self.machine.set_relative_pressure(0.02)),
            Shortcut("Small Decrease Pressure", "7","7", lambda: self.machine.set_relative_pressure(-0.02)),
            Shortcut("Large Decrease Pressure", "6","6", lambda: self.machine.set_relative_pressure(-0.1)),
