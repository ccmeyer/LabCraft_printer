...
could finish. The current next action is one accelerated measured run through
the existing fail-closed Pi lane, followed by JSON, summary, screenshot, event,
manifest, and hash inspection. Preserve the
