...
| 2026-08-24 | Rc.7 release preparation | Merged endpoint-safe XY completion, physical-evidence location verification, plate/Pause synchronization, fresh post-home reconciliation, and Controller-owned rack travel into `main`; prepared rc.7 metadata and advanced Pi recovery defaults | Feature checkpoint `3e568726`; attended plate/rack success and cancellation passed; exact rc.6 released restoration and protected postflight passed; final tag gates in progress | Run firmware, full-suite, metadata, exact-tag Pi, protected-update, and postflight gates before closing rc.7 |
