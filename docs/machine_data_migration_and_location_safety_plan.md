...
| 2026-08-24 | Rc.7 published and LC-001 synchronized | Merged endpoint-safe XY completion, physical-evidence location verification, plate/Pause synchronization, fresh post-home reconciliation, and Controller-owned rack travel; published immutable `v1.3.0-rc.7`; completed the protected rc.6 -> rc.7 update and exact rc.7 firmware deployment | Tag peels to `b6138f9d`; 5,731 full Python tests/156 skipped, 269 release/workflow tests, 485 firmware host tests and Debug build; exact-candidate no-hardware and SAFE roundtrip passed; protected update `b9d8b5b1-5151-439f-95c3-58d984d41812` authorized relaunch with archive `c6056cab...a556b`; final rc.7 SAFE 30/30 evidence `20260824T210545366851Z_360b2b30-bba5-4125-8907-0ad509f6c1af`; final status `20260824T210653768776Z_b6138f9d0292` reports released, `production_ready=true`, zero processes, and only the two retained-worktree warning; operator observed no unexpected activity | Retain the immutable tag and evidence; use the protected updater for additional machines and preserve the staged-rollout gates |
| 2026-08-24 | Exact-tag legacy-cohort rehearsal tooling implemented | Added a standalone-clone public-updater lane, immutable real-backup binding, separate cancellation/activation roots, bootstrap-only visible review, exact migration comparison, second-checkout reopen, protected-invariance seals, and two-cohort aggregation | Two initial rc.1 Prepare attempts failed closed on derived firmware readiness and Pi Git missing-ref behavior; both roots retained; firmware-state parsing and quiet exact-ref checks corrected; 229 focused Windows tests passed | Publish and Pi-qualify the corrective harness, then prepare a fresh rc.1 run and the pending rc.6 run before fleet pilots |
| 2026-08-24 | Rc.7 direct legacy rollout blocked; rc.8 correction started | Rc.1 rehearsal `a9e1dd18...` passed exact update and cancellation, then exposed the target release's rc.2/rc.3-only genesis rule; the disposable root was quarantined with unchanged protected invariants | Implement activation-only evidence-bound rc.8 enrollment before active-pointer publication, publish an immutable successor, and restart both cohorts from fresh run IDs |
| 2026-08-24 | Rc.8 correction published | Added exact legacy-source evidence binding, activation-only genesis authority, pre-pointer anchor durability, and same-release missing-anchor rejection; published immutable `v1.3.0-rc.8` at `f6116043` | Run fresh exact-tag rc.1 and rc.6 cohorts, aggregate their sealed evidence, then perform paused physical pilots before fleet rollout |
...
| 2026-08-24 | Published immutable rc.7 at `b6138f9d`, completed exact-candidate Pi no-hardware/SAFE qualification, performed the attended LC-001 protected rc.6 -> rc.7 update, deployed and SAFE-verified exact rc.7 firmware, and sealed a clean closed-app production-ready postflight with no unexpected operator-observed activity. |
| 2026-08-24 | Added the reusable exact-tag Pi upgrade rehearsal and bootstrap-only harness. Each real legacy cohort now receives a standalone public-updater clone, immutable source copy, independent cancellation/activation roots, exact Camera/config comparison, second-checkout reopen, private evidence seal, and protected production/development/firmware invariance. |
| 2026-08-24 | Recorded the rc.7 direct-legacy activation blocker and advanced the rollout target to rc.8: genesis enrollment is activation-only, exact-evidence-bound, durable before the active pointer, and unavailable to ordinary restart or anchor recreation. |
| 2026-08-24 | Published immutable rc.8 at `f6116043` after 169 affected tests, exact-correction Pi no-hardware qualification, 494 release-focused tests, and the complete 5,785-test/156-skip suite; added the live rc.8 two-cohort rehearsal record. |
