...
> Current correction: rc.3 successfully corrected the protected update and
> enrolled LC-001, but the attended audit exercise found that exact restore
> incorrectly shared the import prohibition on deleting an added target. The
> [rc.4 correction plan](machine_data_migration_milestone_7_rc4_correction_plan.md)
> owns the restore correction and remaining downstream gates.
