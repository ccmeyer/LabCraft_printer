        ...
        "results": [
            {
                ...
                "pass": True,
                "metrics": {"pulse_ms": 2000, "pulses": 18, "ready": 0, "timeout": 0, "focus": 1, "trace": 1, "sc": 96},
            },
            {
                "test_id": 2511,
                "name": "gripper_refresh_hold_3psi_factory",
                "pass": True,
                "metrics": {"psi": 3000, "refresh_ms": 30000, "pulse_int": 10000, "ready": 0, "timeout": 0, "focus": 1, "trace": 1, "sc": 48},
            },
            {
                "test_id": 2512,
                "name": "gripper_motion_raster_3psi_factory",
                "pass": True,
                "metrics": {"psi": 3000, "xy_home_to": 0, "move_to": 0, "guard": 0, "bound": 0, "park_x": 500, "park_y": 500, "park_to": 0, "ready": 0, "timeout": 0, "focus": 1, "trace": 1, "sc": 64},
            },
            {
                "test_id": 2513,
                "name": "gripper_post_motion_seal_compare_factory",
                "pass": True,
                "metrics": {"psi": 3000, "ready": 0, "timeout": 0, "focus": 1, "trace": 1, "sc": 24},
            },
        ],
        "host_checks": [
            {"name": "hello_ack", "pass": True, "details": {"seq8": 1}},
