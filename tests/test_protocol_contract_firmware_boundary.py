...
def test_shared_command_codes_match_firmware_header():
    ...
    shared = {
        ...
        "SET_REG_RECOVERY_PROFILE": "CMD_SET_REG_RECOVERY_PROFILE",
        "SET_REG_SLEW_PROFILE": "CMD_SET_REG_SLEW_PROFILE",
        "SET_REG_READY_PROFILE": "CMD_SET_REG_READY_PROFILE",
        "RESTORE_REG_PROFILE": "CMD_RESTORE_REG_PROFILE",
        "QUERY_REG_PROFILE": "CMD_QUERY_REG_PROFILE",
    }
