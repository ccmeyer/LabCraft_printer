...
def _build_dialog_stub(gripper_loaded: bool, *, manual_assignments: bool = False):
    ...
    dialog.reagent_table.setCellWidget(ExperimentDesignDialog.COL_STOCK_LABEL, 0, QLineEdit())
    dialog.reagent_table.setCellWidget(ExperimentDesignDialog.COL_REAGENT, 0, QComboBox())
    dialog.reagent_table.setCellWidget(ExperimentDesignDialog.COL_GROUP, 0, QComboBox())
    dialog.reagent_table.setCellWidget(ExperimentDesignDialog.COL_HEAD_TYPE, 0, QComboBox())
    dialog.reagent_table.setCellWidget(ExperimentDesignDialog.COL_STARTING, 0, QDoubleSpinBox())
    dialog.reagent_table.setCellWidget(ExperimentDesignDialog.COL_TARGETS, 0, QLineEdit())
    dialog.reagent_table.setCellWidget(ExperimentDesignDialog.COL_UNITS, 0, QLineEdit())
    dialog.reagent_table.setCellWidget(ExperimentDesignDialog.COL_SET_STOCK, 0, QLineEdit())
    dialog.reagent_table.setCellWidget(ExperimentDesignDialog.COL_MAX_STOCK, 0, QLineEdit())
    dialog.reagent_table.setCellWidget(ExperimentDesignDialog.COL_DROPLET, 0, QDoubleSpinBox())
    dialog.reagent_table.setCellWidget(ExperimentDesignDialog.COL_PRIOR, 0, QLabel(""))
    dialog.reagent_table.setCellWidget(ExperimentDesignDialog.COL_DELETE, 0, QPushButton())
