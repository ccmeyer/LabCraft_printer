...
TEST_CATALOG: dict[int, TestCatalogEntry] = {
    ...
    2211: TestCatalogEntry(2211, "Pressure regulator homing", "Print/refuel regulator homing repeatability and timeout behavior."),
    2212: TestCatalogEntry(2212, "Print pressure hold", "Print regulator 2 psi hold stability, correction effort, and leak suspicion."),
    2213: TestCatalogEntry(2213, "Refuel pressure hold", "Refuel regulator 2 psi hold stability, correction effort, and leak suspicion."),
    2214: TestCatalogEntry(2214, "Print pressure cycling", "Print regulator repeatability through adjacent 1 psi target steps from 1 to 3 psi."),
    2215: TestCatalogEntry(2215, "Refuel pressure cycling", "Refuel regulator repeatability through adjacent 1 psi target steps from 1 to 3 psi."),
    2216: TestCatalogEntry(2216, "Print pressure hysteresis", "Print regulator motor-position hysteresis when approaching 2 psi from low and high targets."),
    2217: TestCatalogEntry(2217, "Refuel pressure hysteresis", "Refuel regulator motor-position hysteresis when approaching 2 psi from low and high targets."),
    2218: TestCatalogEntry(2218, "Print pressure step ladder", "Print regulator settling through a 1, 2, 3, 2, 1 psi target ladder."),
    2219: TestCatalogEntry(2219, "Refuel pressure step ladder", "Refuel regulator settling through a 1, 2, 3, 2, 1 psi target ladder."),
