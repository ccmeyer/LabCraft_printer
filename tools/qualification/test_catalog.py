...
TEST_CATALOG: dict[int, TestCatalogEntry] = {
    ...
    2214: TestCatalogEntry(2214, "Print pressure cycling", "Print regulator same-direction low/high repeatability through adjacent 1 psi target steps using production setpoint slew."),
    2215: TestCatalogEntry(2215, "Refuel pressure cycling", "Refuel regulator same-direction low/high repeatability through adjacent 1 psi target steps using production setpoint slew."),
