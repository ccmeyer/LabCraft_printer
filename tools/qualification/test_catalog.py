...
TEST_CATALOG: dict[int, TestCatalogEntry] = {
    ...
    2473: TestCatalogEntry(2473, "Print valve 2 psi repeatability", "Print valve isolated 2 psi repeatability and pulse-width linearity across 1500, 3000, and 4500 us pulses with regulator recovery between replicates."),
    2474: TestCatalogEntry(2474, "Refuel valve 2 psi repeatability", "Refuel valve isolated 2 psi repeatability and pulse-width linearity across 1500, 3000, and 4500 us pulses with regulator recovery between replicates."),
    2475: TestCatalogEntry(2475, "Valve channel balance at 2 psi", "Derived print/refuel channel balance at 2 psi using the isolated repeatability and linearity rows without additional valve actuation."),
