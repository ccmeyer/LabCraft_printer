...
TEST_CATALOG: dict[int, TestCatalogEntry] = {
    ...
    2214: TestCatalogEntry(2214, "Print pressure cycling", "Print regulator repeatability through adjacent 1 psi target steps using production setpoint slew."),
    2215: TestCatalogEntry(2215, "Refuel pressure cycling", "Refuel regulator repeatability through adjacent 1 psi target steps using production setpoint slew."),
    2216: TestCatalogEntry(2216, "Print pressure hysteresis", "Print regulator fresh-home motor-position hysteresis when approaching 2 psi from low and high targets."),
    2217: TestCatalogEntry(2217, "Refuel pressure hysteresis", "Refuel regulator fresh-home motor-position hysteresis when approaching 2 psi from low and high targets."),
    2218: TestCatalogEntry(2218, "Print pressure step ladder", "Print regulator fresh-home settling through a 1, 2, 3, 2, 1 psi target ladder."),
    2219: TestCatalogEntry(2219, "Refuel pressure step ladder", "Refuel regulator fresh-home settling through a 1, 2, 3, 2, 1 psi target ladder."),
