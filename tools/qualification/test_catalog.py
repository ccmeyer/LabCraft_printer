...
TEST_CATALOG: dict[int, TestCatalogEntry] = {
    ...
    2473: TestCatalogEntry(2473, "Print valve 2 psi repeatability", "Print valve isolated 2 psi steady fixed-width settled pressure-drop repeatability and pulse-width linearity across grouped 1500, 3000, and 4500 us pulses; first-after-width-change, ringing, actuation latency, and regulator-position context are retained as diagnostics."),
    2474: TestCatalogEntry(2474, "Refuel valve 2 psi repeatability", "Refuel valve isolated 2 psi steady fixed-width settled pressure-drop repeatability and pulse-width linearity across grouped 1500, 3000, and 4500 us pulses; first-after-width-change, ringing, actuation latency, and regulator-position context are retained as diagnostics."),
    2475: TestCatalogEntry(2475, "Valve channel balance at 2 psi", "Derived print/refuel channel balance at 2 psi using the isolated grouped steady settled-drop repeatability and linearity rows without additional valve actuation."),
    2476: TestCatalogEntry(2476, "Print valve 1500 us gap sweep", "Exploratory print valve 2 psi 1500 us settled pressure-drop response versus post-ready settle gap, with latency and ringing treated as diagnostic context."),
    2477: TestCatalogEntry(2477, "Refuel valve 1500 us gap sweep", "Exploratory refuel valve 2 psi 1500 us settled pressure-drop response versus post-ready settle gap, with latency and ringing treated as diagnostic context."),
    2478: TestCatalogEntry(2478, "Print valve gap controls", "Exploratory print valve 2 psi 3000 and 4500 us control pulses at short and long post-ready settle gaps."),
    2479: TestCatalogEntry(2479, "Refuel valve gap controls", "Exploratory refuel valve 2 psi 3000 and 4500 us control pulses at short and long post-ready settle gaps."),
