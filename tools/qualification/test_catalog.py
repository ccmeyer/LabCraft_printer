...
TEST_CATALOG: dict[int, TestCatalogEntry] = {
    ...
    2214: TestCatalogEntry(2214, "Print pressure cycling", "Print regulator repeatability when cycling between 1 psi and 3 psi targets."),
    2215: TestCatalogEntry(2215, "Refuel pressure cycling", "Refuel regulator repeatability when cycling between 1 psi and 3 psi targets."),
