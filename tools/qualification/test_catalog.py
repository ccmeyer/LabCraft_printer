...
TEST_CATALOG: dict[int, TestCatalogEntry] = {
    ...
    2473: TestCatalogEntry(2473, "Print valve 2 psi repeatability", "Print valve isolated 2 psi settled pressure-drop repeatability, pulse-width linearity, ringing amplitude, actuation latency, and regulator-position context across grouped 1500, 3000, and 4500 us pulses."),
    2474: TestCatalogEntry(2474, "Refuel valve 2 psi repeatability", "Refuel valve isolated 2 psi settled pressure-drop repeatability, pulse-width linearity, ringing amplitude, actuation latency, and regulator-position context across grouped 1500, 3000, and 4500 us pulses."),
    2475: TestCatalogEntry(2475, "Valve channel balance at 2 psi", "Derived print/refuel channel balance at 2 psi using the isolated grouped settled-drop repeatability and linearity rows without additional valve actuation."),
    2476: TestCatalogEntry(2476, "Print valve 1500 us gap sweep", "Exploratory print valve 2 psi 1500 us pulse response versus post-ready settle gap."),
    2477: TestCatalogEntry(2477, "Refuel valve 1500 us gap sweep", "Exploratory refuel valve 2 psi 1500 us pulse response versus post-ready settle gap."),
