...
TEST_CATALOG: dict[int, TestCatalogEntry] = {
    ...
    2106: TestCatalogEntry(2106, "Coordinated XY pause/resume fresh replan", "Six 40 kHz coordinated moves paused across early, middle, and late profile phases; STEP-low two-second holds; 3 kHz fresh replans of the remaining endpoint; no enable cycle; and post-run X/Y home drift."),
    2107: TestCatalogEntry(2107, "Direct Z pause/resume fresh replan", "Six 30 kHz direct Z moves with STEP-low two-second holds, 3 kHz fresh replans of the remaining endpoint, no enable cycle, and post-run Z home drift."),
